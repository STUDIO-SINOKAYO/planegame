...
func fade_in_tutorial_text() -> void:
	...
	# Create separate tween for tutorial text (parallel to dotted line)
	var text_tween = create_tween()
	text_tween.tween_property(tutorial_text, "modulate:a", 1.0, 1.0)  # Fade in over 1 second
...
func fade_out_tutorial_text() -> void:
	...
	# Create separate tween for tutorial text (parallel to dotted line)
	var text_tween = create_tween()
	text_tween.tween_property(tutorial_text, "modulate:a", 0.0, 0.5)  # Fade out over 0.5 seconds
